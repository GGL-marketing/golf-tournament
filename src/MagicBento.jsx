...
const GOLD_GLOW_COLOR = '213, 175, 76';
const MOBILE_BREAKPOINT = 768;

const createParticleElement = (x, y, color = GOLD_GLOW_COLOR) => {
...
const GlobalSpotlight = ({ gridRef, disableAnimations = false, enabled = true, spotlightRadius = DEFAULT_SPOTLIGHT_RADIUS, glowColor = GOLD_GLOW_COLOR }) => {
